...
```
https://github.com/campfoursoftware/trackless-sdk-ios
```
...
```swift
dependencies: [
    .package(url: "https://github.com/campfoursoftware/trackless-sdk-ios", from: "1.0.0")
]
```
...
.target(
    name: "MyApp",
    dependencies: [
        .product(name: "TracklessTelemetry", package: "trackless-sdk-ios")
    ]
)
```
